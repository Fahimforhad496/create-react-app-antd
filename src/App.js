...
const DefaultAntd = () => (
    <>
        ...
        <Form labelCol={{ span: 6 }} wrapperCol={{ span: 12 }}>
            <Form.Item label="Text Box">
                <InputNumber min={0} max={1000} defaultValue={1} />
                <span className="ant-form-text"> This is ant form text</span>
                <a href="https://ant.design">this is a link</a>
            </Form.Item>
            <Form.Item label="Toggle Menu">
...
const App = () => <SidebarLayout></SidebarLayout>;
